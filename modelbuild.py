...
num_classes = 36  # Adjust to the number of output classes in your dataset


# Function to create the CNN model
def create_cnn_model(input_shape=(64, 64, 3), num_classes=26, dropout_rate=0.5):
...
# Function to compile the CNN model
...
# Function to save the model summary to a file
...
# Function to save model configuration as JSON
...
# Main function to create, compile, and save the CNN model
def main():
    input_shape = (64, 64, 3)  # Modify if needed
    dropout_rate = 0.5         # Adjust for regularization
    learning_rate = 0.001      # Change learning rate for optimizer
    ...
    # Save model summary and configuration for future reference
