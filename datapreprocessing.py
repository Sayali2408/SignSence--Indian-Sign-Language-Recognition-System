...
def main():
    train_dir = r"split_dataSet\train"  # Change if needed
    val_dir = r"split_dataSet\val"  # Change if needed
    target_size = (64, 64)  # Modify if your model requires a different input size
    batch_size = 32  # Adjust based on hardware and dataset size
    validation_split = 0.2  # Change for a different train-validation split
