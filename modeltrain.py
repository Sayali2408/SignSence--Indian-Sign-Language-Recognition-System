...
num_classes = 36  # Update this to match the number of classes in your dataset

# Directory paths for training and validation data
train_dir = r'split_dataSet\train'  # Replace with your training data path
val_dir = r'split_dataSet\val'  # Replace with your validation data path

# Model architecture
def create_cnn_model(input_shape=(64, 64, 3), num_classes=36, dropout_rate=0.5):
    print("\nCreating CNN model...")
    model = Sequential([
...
def main():
    ...
    model = create_cnn_model(input_shape=(64, 64, 3), num_classes=num_classes, dropout_rate=0.5)
